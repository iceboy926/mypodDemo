...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/iceboy926/mypodDemo"
  ...
  s.author             = { "mandos" => "anddy926@163.com" }
  # Or just: s.author    = "mandos"
  # s.authors            = { "mandos" => "anddy926@163.com" }
  # s.social_media_url   = "http://twitter.com/mandos"
  ...
  s.source       = { :git => "https://github.com/iceboy926/mypodDemo.git", :tag => "0.0.1" }
